...
def model_init(model_path=None, **kwargs):
    ...
    processor = {
        ...
        'video': partial(process_video, processor=processor, aspect_ratio=None, num_frames=None),
    }
...
def mm_infer(image_or_video, instruct, model, tokenizer, modal='video', **kwargs):
    ...
    message = system_message + message #+[{'role': 'assistant', 'content':"The best option is"}]
...
#     prompt += '\nThe best option is ('
    ...
    # print(prompt, stopping_criteria, outputs, input_ids.shape)
    # raise
    return outputs
