...
class ActivitynetDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for fmt in self.video_formats:  # Added this line
            temp_path = os.path.join(args.video_folder, f"video{video_name}{fmt}")
            print(temp_path)
        ...
        if video_path is None:
            raise FileNotFoundError(f"Video file not found for {os.path.join(args.video_folder, str(video_name))}")
